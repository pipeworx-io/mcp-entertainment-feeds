...
const tools: McpToolExport['tools'] = [
  {
    name: 'list_feeds',
    description: 'List the curated entertainment & culture feeds (id, title, category, source). Optionally filter by category (books, entertainment) or keyword. Pass an id to read_feed.',
    inputSchema: {
      type: 'object',
      properties: {
        category: { type: 'string', description: 'Filter by category: books, entertainment.' },
